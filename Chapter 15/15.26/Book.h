...
{
	cout << "Quote 移动构造函数" << endl;
}
Quote& Quote::operator=(const Quote& q)
{
	bookNo = q.bookNo;
	price = q.price;
	cout << "Quote 拷贝赋值运算符" << endl;
	return *this;
}
...
public:
	Disc_quote() = default;
	Disc_quote(const Disc_quote&);   //拷贝构造函数
	Disc_quote(Disc_quote&&);   //移动构造函数
	Disc_quote& operator=(const Disc_quote&);   //拷贝赋值运算符
	Disc_quote& operator=(Disc_quote&&);   //移动赋值运算符
...
public:
	Bulk_quote() = default;
    Bulk_quote(const Bulk_quote&);   //拷贝构造函数
	Bulk_quote(Bulk_quote&&);   //移动构造函数
	Bulk_quote& operator=(const Bulk_quote&);   //拷贝赋值运算符
	Bulk_quote& operator=(Bulk_quote&&);   //移动赋值运算符
